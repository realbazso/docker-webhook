...
#RUN            curl -f -L -o /tmp/webhook-${WEBHOOK_VERSION}.tar.gz https://github.com/adnanh/webhook/archive/${WEBHOOK_VERSION}.tar.gz
RUN            curl -f -L -o /tmp/webhook-2.6.0.tar.gz https://github.com/adnanh/webhook/archive/2.6.0.tar.gz
